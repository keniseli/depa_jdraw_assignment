...
public class DrawModelTest {
	...
	public void testAddFigure3() {
		...
		m.addFigure(f);
		assertEquals("addFigure should notify a FIGURE_ADDED event", DrawModelEvent.Type.FIGURE_ADDED, type);
	}
	...
	public void testRemoveAllFigures1() {
		...
		m.addModelChangeListener(l);
		m.removeAllFigures();
		assertEquals("removeAllFigures should notify a DRAWING_CLEARED event", DrawModelEvent.Type.DRAWING_CLEARED,
				type);
	}
	...
	public void testSetFigureIndex1() {
		...
		assertEquals("setFigureIndex should notify a DRAWING_CHANGED event", DrawModelEvent.Type.DRAWING_CHANGED, type);
	}
	...
	public void testSetFigureIndex3() {
		...
		assertTrue("in case that an IndexOutOfBoundsException occurs, the figure must not be removed from the model",
